...
| OCR 识别 | 自动 OCR 开 · 页数上限 100 · 并发 3 · 扫描页阈值 30 字符 · 模型 `deepseek-v4-flash-vision-exp` · 端点 `https://api.deepseek.com` · 密钥变量 `DEEPSEEK_API_KEY` · 截断自动加倍重试 |
...
解析管线版本升级至 `EXTRACTOR_VERSION = 3`：旧文档重新导入时自动重新提取，
